...
public class actOfferChoise extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    Context context = this;
    adapOfferChoise adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_offer_choise);
...
//                startActivity(intent, options.toBundle());
    ...
    void initialize(){
        String Query = "SELECT * FROM TB_OfferChoise";
        ...
        adapter = new adapOfferChoise(lDiscount, context);
