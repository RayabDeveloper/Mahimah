...
public class adapDiscount extends BaseAdapter {

    Context mContext;

    private LayoutInflater mInflater;
    public List<Datas.SubServicesDiscount> lList;
    int positioner = 0;

    public adapDiscount(Context context, List<Datas.SubServicesDiscount> lList, int positioner){
    ...
    adapCounter.AdapterMember Members = null;
    ...
    public View getView(final int position, View ConvertView, final ViewGroup Parent){
        ...
        if(ConvertView == null){
            ...
            Members                             = new adapCounter.AdapterMember();
            Members.imgCounter                  = (ImageView)ConvertView.findViewById(R.id.imgCount);
            Members.imgSelected                 = ConvertView.findViewById(R.id.imgSelected);

            ConvertView.setTag(Members);
        }else{
            Members = (adapCounter.AdapterMember)ConvertView.getTag();
        }
